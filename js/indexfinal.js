        ...
        <section class="container">
                            <div class="row  col-md-12  justify-content-between gap-3 pt-5 px-5">
                                <div class="col-md col-sm-12  pt-3 px-3 bg-dark-subtle rounded">
                                    <h5 class="text-center">${tool.description}</h5>
                                    
                                    <div class="row col-md-12 gap-2 py-2 px-2 justify-content-between ">
                                        <div class=" col-md-3 col-sm-12 px-2 bg-light rounded border border-light-subtle text-primary-emphasis text-center fw-semibold">
                                            <p>${tool.pricing[0].price}</p>
                                            <hr>
                                            <p>${tool.pricing[0].plan} </p>
                    
                                        </div>
                                        <div class="col-md-3 col-sm-12 px-2 bg-light rounded border border-light-subtle text-center text-success fw-semibold">
...
//Ascending sort by date button function 
