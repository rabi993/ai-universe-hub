...
const loadPhones = async () => {
    ...
    displayPhones(tools, 6);
};

const displayPhones = (tools, dataLimit) => {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 d-flex justify-content-between ">
                        ...
                        <div class="col">
                        <button onclick="loadPhoneDetails('${tool.id}')" class="btn position-absolute bottom-0 end-0 " data-bs-toggle="modal" data-bs-target="#phoneDetailModal "><i class='fas fa-arrow-right' style='font-size:30px;color:red'></i></button>
                        </div>
                    </div>
                </div>
            </div>
...
const processSearch = () => {
    ...
    const filteredPhones = tools.filter(tool =>
...
const displayPhoneDetails = tool => {
        ...
        <section class="container">
                            <div class="row  col-md-12  justify-content-between gap-3 pt-5 px-5">
                                ...
                                <div class="col-md col-sm-12 px-3 border border-light-subtle rounded">
                                    ...
                                    <button id="btn-acc" type="button" class="btn rounded-5 btn-danger  position-absolute top-0 end-0 " >Accuracy: ${tool.accuracy.score ===null ? 'not found': tool.accuracy.score }
                                    </button>
